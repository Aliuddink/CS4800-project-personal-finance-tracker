        ...
        <div className="relative">
          ...
          <div className="bg-white w-full max-w-2xl p-6 rounded-lg shadow-lg z-10 relative"> {/* Adjusted padding */}
            ...
            <div className="flex flex-col items-center space-y-4 w-full">
                <div className="bg-gray-500 w-96 h-20 rounded-lg shadow-md flex items-center p-4">
                    <img
                    ...
                    <input
                        ...
                        className="bg-gray-500 w-full h-full rounded-lg pl-1 outline-none text-white placeholder-white text-xl"
                    />
                </div>
                <div className="bg-gray-500 w-96 h-20 rounded-lg shadow-md flex items-center p-4">
                    <img
            ...
            <div className="flex justify-center mt-2">
                <span className="text-sm text-gray-600">Have an account? <span className="text-blue-500 cursor-pointer">Sign in</span></span>
            </div>
          </div>
